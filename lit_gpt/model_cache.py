...
class GPTCache(nn.Module):
    ...
    def forward(
        self, idx: torch.Tensor,  pc=None, global_pc=None, bd_token=None, max_seq_length: Optional[int] = None, input_pos: Optional[torch.Tensor] = None,
        start: Optional[int] = 0, window_size: Optional[int] = -1, boundry_length: Optional[int] = 0
    ) -> torch.Tensor:
        # import pdb;pdb.set_trace()
        B, T = idx.size()
